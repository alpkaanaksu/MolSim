...
void ParticleContainer::add(const nlohmann::json &objects) {
    for (auto &object: objects) {
        if (object["type"] == "particle") {
            ...
            add(Particle{object["position"], object["velocity"], f, old_f, object["mass"], object["epsilon"], object["sigma"], object["type_id"], 0.0, 0, object.contains("fixed") && object["fixed"]});
          
        } else if (object["type"] == "cuboid") {
            Generator::cuboid(*this, object["position"], object["size"], object["mesh_width"], object["velocity"],
                              object["mass"], object["type_id"], object["epsilon"], object["sigma"], object.contains("fixed") && object["fixed"]);
