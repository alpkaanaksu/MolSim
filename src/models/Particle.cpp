...
Particle::Particle(std::array<double, 3> x_arg, std::array<double, 3> v_arg,
   ...
   : x(x_arg), v(v_arg), m(m_arg), type(type_arg), f({0., 0., 0.}), old_f({0., 0., 0.}), epsilon(eps), sigma(sig) {
...
Particle::Particle(std::array<double, 3> x_arg, std::array<double, 3> v_arg, std::array<double, 3> f_arg, std::array<double, 3> old_f_arg,
        ...
        : x(x_arg), v(v_arg), m(m_arg), f(f_arg), old_f(old_f_arg), type(type_arg), epsilon(eps), sigma(sig) {
