...
Particle::Particle(const Particle &other)
        : x(other.x), v(other.v), f(other.f), old_f(other.old_f),
          ...
          type(other.type), directNeighbors(other.directNeighbors), diagonalNeighbors(other.diagonalNeighbors), avgBondLength(other.avgBondLength), stiffnessFactor(other.stiffnessFactor), pulled(other.pulled), id(other.id) {
